...
| T0 | Booking | Вход в запись | Главное меню → ✂️ Записаться | Появляется hub выбора сценария: услуга/специалист/дата-время | пустой список, нет Back/Home | Активный YClients | `flows/booking.py` |
