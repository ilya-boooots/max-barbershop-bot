...
def _apply_migrations(connection: sqlite3.Connection) -> None:
    ...
    _ensure_column(connection, "birthday_funnel_events", "yclients_client_id", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "client_tg_id", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "birth_date", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "birthday_year", "INTEGER")
    _ensure_column(connection, "birthday_funnel_events", "scheduled_send_at_utc", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "sent_at_utc", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "clicked_at_utc", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "yclients_booking_id", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "branch_timezone", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "source", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "is_test", "INTEGER NOT NULL DEFAULT 0")
    _ensure_column(connection, "birthday_funnel_events", "error_summary", "TEXT")
    _ensure_column(connection, "birthday_funnel_events", "updated_at_utc", "TEXT")
