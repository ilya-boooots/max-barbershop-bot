...
BOOKING_EMPTY_TEXT = "😕 В этой категории пока нет доступных услуг."
...
BOOKING_STALE_DATE_TEXT = "😔 На эту дату свободных окон нет. Выберите другой день 🙂"
BOOKING_STALE_SLOT_TEXT = "😔 Это окно уже неактуально. Обновляю список 🙂"
